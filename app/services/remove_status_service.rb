...
class RemoveStatusService < BaseService
  ...
  def remove_from_public
    ...
    if @status.local?
      ...
      redis.publish("timeline:public:remote:#{@account.domain.mb_chars.downcase}", @payload)
    end
  end
  ...
  def remove_from_media
    ...
    if @status.local?
      ...
      redis.publish("timeline:public:remote:media:#{@account.domain.mb_chars.downcase}", @payload)
    end
  end
